(function(){
	...
	TweenMax.from(".bannerTxt .upper", 1, {
		delay: 3.2,
		alpha: 0,
		y: 20,
		ease: Expo.easeInOut
	...
	if ($(window).width() > 800) {
		...
		// TweenMax.from(".swiper-pagination", 1, {
		// 	delay: 3.8,
		// 	alpha: 0,
		// 	x: 20,
		// 	ease: Expo.easeInOut
		// });
		// TweenMax.staggerFrom(".swiper-pagination span", 1, {
		// 	delay: 4,
		// 	alpha: 0,
		// 	x: 20,
		// 	ease: Power3.easeInOut
...
//scoll animation each div
var controller = new ScrollMagic.Controller();

$('[data-scrollmagic]').each(function(index) {
 var tl = new TimelineMax();
  tl.fromTo(this, 0.4, { delay:1, y: 100, opacity: 0 }, { y: 0, opacity: 1, ease: Power2.EaseInOut });
...
$(document).ready(function() {
  	...
  	$('.yt-thumb').each(function(){
		...
		$(this).css({'width':getImageSrcW+'px','height':getImageSrcH+'px'});
      ...
      on: {
        ...
        imagesReady: function(){
          ...
          for (let i = 0; i < swiper.slides.length; i++) {
            swiper.slides[i].querySelector(".entity-img").remove();
          }
        },
        progress: function(){
          let swiper = this;
